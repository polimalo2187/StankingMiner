...
if (fs.existsSync(DB_FILE)) {
  try { users = JSON.parse(fs.readFileSync(DB_FILE, 'utf8')) } catch (e) { console.log('Error cargando DB:', e) }
}
...
bot.launch()
console.log('STANKING MINER 100% ACTIVO CON VERIFICACIÓN – COBRANDO 24/7 EN LA NUBE')
