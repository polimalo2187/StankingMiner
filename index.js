...
bot.action('menu_mineria', async (ctx) => {
  ...
  ctx.reply(
    puede ? "*¡RECLAMA 0.03 USDT!*" : "Espera 24h",
    {
      parse_mode: "Markdown",
      reply_markup: puede
        ? { inline_keyboard: [[{ text: "RECLAMAR", callback_data: "mine" }], [{ text: "⬅️ Regresar", callback_data: "menu_principal" }]] }
        : { inline_keyboard: [[{ text: "⬅️ Regresar", callback_data: "menu_principal" }]] }
    }
  )
})
