...
// =====================================================
//   CONFIG WEBHOOK PARA RAILWAY (EVITA ERROR 409)
// =====================================================
const WEBHOOK_URL = process.env.WEBHOOK_URL;

// BORRAR WEBHOOK ANTERIOR PARA EVITAR CONFLICTO
bot.telegram.deleteWebhook().catch(() => {});

// =====================================================
//   SERVIDOR HTTP (Railway lo requiere activo)
// =====================================================
http
...
// =====================================================
//     INICIAR BOT USANDO WEBHOOK (NO POLLING)
// =====================================================
bot.launch({
  webhook: {
    domain: WEBHOOK_URL,
  ...
  .then(() => console.log("🚀 Bot iniciado con WEBHOOK correctamente"))
